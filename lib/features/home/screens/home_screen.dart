                ...
                onTap: () {
                  if (_upcomingMatches.isNotEmpty) {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) => EsCreateTeamScreen(
                          matchData: _upcomingMatches.first,
                        ),
                      ),
                    );
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) =>
                            EsCreateTeamScreen(matchData: _liveMatches.first),
                      ),
                    );
                  }
                },
            ...
            children: [
              ...
              Expanded(
                child: _QuickActionCard(
                  ...
                  onTap: () {
                    final target = _upcomingMatches.isNotEmpty
                        ? _upcomingMatches.first
                        : (_liveMatches.isNotEmpty ? _liveMatches.first : null);
                    if (target != null) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  _TeamRow(
                    team: teamA,
                    isWinner: data['winning_team_id'] == teamA['team_id'],
                  ),
                  const SizedBox(height: 6),
                  const Center(
                    child: Text(
                  ...
                  _TeamRow(
                    team: teamB,
                    isWinner: data['winning_team_id'] == teamB['team_id'],
                  ),
                ],
              ),
            ),
...
class _TeamRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final name =
        team['short_name']?.toString() ?? team['name']?.toString() ?? '?';
  ...
  Widget build(BuildContext context) {
    if (matches.isEmpty) {
      return Center(
        child: Column(
          ...
          children: [
            Icon(
              isLive ? Icons.live_tv : Icons.sports_cricket,
              size: 60,
              color: AppColors.textLight,
            ),
            const SizedBox(height: 16),
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, i) => _FullMatchCard(
          data: matches[i],
          isLive: isLive,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '${venue['name'] ?? ''} ${venue['location'] != null ? "· ${venue['location']}" : ""}'
                          .trim(),
                      style: const TextStyle(
                        fontSize: 11,
                        color: AppColors.textLight,
